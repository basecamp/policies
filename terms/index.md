...
When we say “Company”, “we”, “our”, or “us” in this document, we are referring to PROXIMA B SASU. We spun off Highrise HQ, LLC in the past, but it has since rejoined PROXIMA B SASU.

When we say “Services”, we mean any product created and maintained by PROXIMA B SASU. That includes Basecamp (all versions), HEY, Highrise, Campfire, Backpack, Ta-da List, and Writeboard, whether delivered within a web browser, desktop application, mobile application, or another format.
