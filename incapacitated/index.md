---
title: 'How to manage the Ditto account of someone who is incapacitated or has died'
description: 'For Ditto accounts'
---

# How to manage the Ditto account of someone who is incapacitated or has died

First, we are so sorry. Managing administrative aspects is often the last thing you may want to do under these circumstances. We’ve tried to set up a process that makes managing your loved one’s Ditto account as smooth as possible while also honoring the privacy and security obligations we have to our customers.
...
**If you have the login credentials of the account,** you can manage billing, see data, and cancel an account through the Billing page. You can access the Billing portal via the Billing page in the menu.

**If you do not have login credentials but do have legal authority to manage someone's affairs,** we will still try to help. However, please know in advance that we cannot provide login credentials. The following process may take anywhere from 4-7 days as we go through verification steps. To get started, please email [support@ditto.events](mailto:support@ditto.events) with:
...
* The email address associated with the account of your loved one
* A few pieces of information to help with the verification process:
  ...
  - A photograph showing the following things in the same picture: 1. a photo selfie showing your face; 2. a picture of your Government Issued ID (Passport, Drivers License, etc...) next to your face; 3. a piece of paper with "Verification for Ditto" and today’s date
...
Please get in touch with our [support team](mailto:support@ditto.events).
