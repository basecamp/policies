...
**This policy applies to any product created and owned by Sidenote, Lda.. That includes Basecamp (any version), HEY, Highrise, Campfire, Backpack, Writeboard, and Ta-da List. There are [some nuances with HEY](hey) because its subscriptions are on an annual basis only.*
