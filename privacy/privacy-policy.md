...
When you pay for Basecamp, we'll ask for your credit card and billing address. That's so we can charge you for service, calculate taxes due, and send you invoices. Your credit card is passed directly to our payment processor; we don't store it, and it doesn't pass through our servers at all. We store your billing address to print on your invoices, to calculate any sales tax due in the United States, and to detect fraudulent credit card transactions.
